...
class Context : public std::enable_shared_from_this<Context> {
  public:
	...
	Context(const Context *other);
	Context(std::string_view name, std::string_view filePath,
			ContextType type = CONTEXT_TYPE_DEFAULT);
	Context(std::string_view name, std::string_view filePath, ContextPtr parent,
			ContextType type = CONTEXT_TYPE_DEFAULT, bool root = false);
	Context(std::string_view name, std::string_view filePath, symbolTable symbols,
			ContextType type = CONTEXT_TYPE_DEFAULT);
	Context(std::string_view name, std::string_view filePath, symbolTable symbols,
			ContextPtr parent, ContextType type = CONTEXT_TYPE_DEFAULT, bool root = false);
	~Context();
